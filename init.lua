...
vim.keymap.set('n', '<leader>fd', ':Telescope fd<CR>', { desc = 'open the fd thing' })
...
require('lazy').setup({
  ...
  { -- Adds git related signs to the gutter, as well as utilities for managing changes
    ...
    opts = {
      ...
      -- TOMAS: navigate between different hunks
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>s/', function()
        builtin.live_grep {
          -- grep_open_files = true, -- TOMAS: commented this out so that it searches all files
